        ...
        <div className="md:px-14 py-14">
            ...
            <div className="w-11/12 mx-auto gap-10 py-12 flex flex-col md:flex-row items-center md:items-start mb-10">
                        ...
                        <div className="divide-y divide-gray-100">
                            ...
                            <details className="group bg-white px-4 p-1">
                                ...
                                <div className="pb-4 text-secondary-500">
                                    Students can explore various work opportunities through university programs, including internships, assistantships, and off-campus employment options.
                                </div>
                            </details>
                        </div>
                    </div>
                ...
                <div className="w-full md:w-1/2 md:ml-12">
                    <img src={FAQSIMG} alt="Left Image" className="rounded-md" />
                </div>
